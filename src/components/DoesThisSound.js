...
const DoesThisSound = () => {
  ...
  const handleScroll = (direction) => {
    boxContainerRef.current.scrollBy({
      top: 0,
      left: direction * 500, // Adjust the value for scrolling left or right
      behavior: "smooth",
    });
  };
  ...
  useEffect(() => {
    if (isIntersecting) {
      boxContainerRef.current.scrollBy({
        top: 0,
        left: 500, // Adjust this value for initial scroll to the right
        behavior: "smooth",
      });
    }
  }, [isIntersecting]);
  ...
  return (
    <section className="overflow-x-hidden mt-12 mb-32 p-4 px-20" ref={ref}>
      ...
      >
        ...
        <div className="rounded-xl bg-cyan-200 min-w-[350px]  p-6 flex flex-col gap-4 hover:scale-110 hover:-rotate-12 hover:duration-300 ease-in-out">
        ...
        <div className="rounded-xl bg-sky-100 min-w-[350px]  p-6 flex flex-col gap-4 hover:scale-110 hover:-rotate-12 hover:duration-300  ease-in-out">
          {/* <Image width={70} height={70} alt="" src="/angry-emoji.svg" /> */}
          <p className="text-2xl">😠</p>
        ...
        <div className="rounded-xl bg-blue-600 min-w-[350px]  p-6 flex flex-col gap-4 hover:scale-110 hover:-rotate-12 hover:duration-300  ease-in-out">
        {/* <Image width={70} height={70} alt="" src="/angry-emoji.svg" /> */}
        <p className="text-2xl">😳</p>
        ...
        <div className=" rounded-xl bg-yellow-100 min-w-[350px]  p-6 flex flex-col gap-4 hover:scale-110 hover:-rotate-12 hover:duration-300 ease-in-out">
        {/* <Image width={70} height={70} alt="" src="/angry-emoji.svg" /> */}
        <p className="text-2xl">🤨</p>
          <h3 className="font-bold text-lg ">
