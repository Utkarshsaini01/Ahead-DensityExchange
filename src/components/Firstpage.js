            ...
            <div style={{ height: "550px" }} className='bg-bgBlue relative rounded-3xl flex flex-col md:flex-row overflow-hidden'>
                ...
                <div className='basis-1/2 flex items-center justify-center w-full'>
                    ...
                    <motion.div
                        ...
                        {/* red ghost */}
                        <motion.div whileInView="visible" viewport={{ once: true }} animate={{ rotate: -360 }} transition={{ type: "spring", duration: 4, bounce: 0.4 }} style={{ top: "55px" }} className='absolute h-18 w-16'><Image height={100} width={100} className='h-full w-full' src="/blue-ghost.png" alt="" /></motion.div>
                        {/* blue ghost */}
                        <motion.div whileInView="visible" viewport={{ once: true }} animate={{ rotate: -360 }} transition={{ type: "spring", duration: 4, bounce: 0.4 }} style={{ right: "-30px", top: "50%", transform: "translate(-50%,-50%)" }} className='absolute h-18 w-16'><Image height={100} width={100} className='h-full w-full' src="/red-ghost.png" alt="" /></motion.div>
                        {/* voilet ghost */}
                        <motion.div whileInView="visible" viewport={{ once: true }} animate={{ rotate: -360 }} transition={{ type: "spring", duration: 4, bounce: 0.4 }} style={{ bottom: "-2px", right: "54%" }} className='absolute h-10 w-12'><Image height={100} width={100} src="/pinkghost.jpeg" alt="" /></motion.div>
                    </motion.div>
                </div>
