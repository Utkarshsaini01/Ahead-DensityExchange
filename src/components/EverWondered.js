        ...
        <div className="mt-16 shadow bg-white rounded-xl w-[50rem] p-6 py-24 relative">
          <div className="flex justify-between ">
            ...
            <div className="h-4 w-4 rounded-full bg-blue-400 z-10 relative">
              ...
              >
                <div className="absolute whitespace-nowrap text-white p-3 bg-blue-300 rounded top-[2rem] left-[82%]">
                  Anonymous 1
                </div>
              </motion.div>
            </div>
            <div className="h-4 w-4 rounded-full bg-orange-400 z-10 relative">
              ...
              >
                <div className="absolute  whitespace-nowrap  text-white p-2 bg-orange-300 rounded top-[-3rem] left-[0.5rem]">
                  Anonymous 2
                </div>
              </motion.div>
            </div>
            <div className="h-4 w-4 rounded-full bg-green-400 z-10 relative">
              ...
              >
                <div className="absolute  whitespace-nowrap   text-white p-3 bg-green-300 rounded  top-[2rem] left-[82%]">
                  Anonymous 3
                </div>
              </motion.div>
            </div>
